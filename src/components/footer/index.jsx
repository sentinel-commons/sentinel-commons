    ...
    <div className="footer">
      <div className="footer__brand pa4">
        ...
        <div className="footer__brand__social-image-links social-image-links mb4-l">
          ...
          <a className="footer__link" target="_blank" rel="noopener noreferrer" alt="Facebook - Sentinel Commons" href="https://www.facebook.com/Sentinel-Commons-376126159674422s">
